...
import { college } from 'public'

const abouts = [
    { title: 'Learning', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor', imgUrl: college},
    { title: 'Fast', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor', imgUrl:''},
    { title: 'Fast', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor', imgUrl:''},
    { title: 'Fast', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor', imgUrl:''},
]
            ...
            {abouts.map((about, index) => (
                <motion.div
                    ...
                    className='flex justify-start items-start flex-col m-2 w-[190px]'>
                        <Image src={about.imgUrl} alt='about-picture' className='w-[100%] height-[170px] rounded-md object-cover'/>
